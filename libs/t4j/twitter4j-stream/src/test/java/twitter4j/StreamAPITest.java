...
public class StreamAPITest extends TwitterTestBase implements StatusListener, ConnectionLifeCycleListener {
    ...
    public void testStatusStream() throws Exception {
        ...
        stream.next(this);
        waitForNotification();
        assertEquals("Acho retartado ter que esperar para usar o script de novo, por isso só uso o MyTwitter Followers, o site da empresa é: http://bit.ly/5tNlDp", status.getText());
        stream.next(this);
        waitForNotification();
