...
public interface StatusListener extends StreamListener {
     ...
     * @see <a href="https://dev.twitter.com/docs/streaming-api/concepts#parsing-responses">Streaming API Concepts | MyTwitter Developers</a>
     ...
     * @see <a href="https://dev.twitter.com/docs/streaming-api/concepts#filter-limiting">Streaming API Concepts - Filter Limiting | MyTwitter Developers</a>
     * @see <a href="https://dev.twitter.com/docs/streaming-api/concepts#parsing-responses">Streaming API Concepts - Parsing Responses | MyTwitter Developers</a>
     * @see <a href="http://groups.google.co.jp/group/twitter-development-talk/browse_thread/thread/15d0504b3dd7b939">MyTwitter Development Talk - Track API Limit message meaning</a>
     * @since Twitter4J 2.1.0
     */
