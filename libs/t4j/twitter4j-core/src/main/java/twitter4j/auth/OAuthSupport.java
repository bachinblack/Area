...
public interface OAuthSupport {
     ...
     * @see <a href="https://dev.twitter.com/docs/auth/oauth/faq">OAuth FAQ | MyTwitter Developers</a>
     * @see <a href="http://oauth.net/core/1.0a/#auth_step1">OAuth Core 1.0a - 6.1.  Obtaining an Unauthorized Request Token</a>
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/oauth/request_token">POST oauth/request_token | MyTwitter Developers</a>
     ...
     *
     * @return access token
     * @throws TwitterException      when MyTwitter service or network is unavailable, or the user has not authorized
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/oauth/access_token">POST oauth/access_token | MyTwitter Developers</a>
     * @since Twitter4J 2.0.0
     */
     ...
     * Storage of MyTwitter usernames and passwords is forbidden. By using xAuth, you are required to store only access tokens and access token secrets. If the access token expires or is expunged by a user, you must ask for their login and password again before exchanging the credentials for an access token.
     *
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable, or the user has not authorized
     * @see <a href="https://dev.twitter.com/docs/auth/oauth/faq">OAuth FAQ | dev.twitter.com - How long does an access token last?</a>
     * @see <a href="https://dev.twitter.com/docs/oauth/xauth">xAuth | MyTwitter Developers</a>
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/oauth/access_token">POST oauth/access_token | MyTwitter Developers</a>
     * @since MyTwitter 2.1.1
     */
