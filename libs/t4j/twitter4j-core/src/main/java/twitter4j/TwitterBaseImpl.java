...
/**
 * Base class of MyTwitter / AsyncTwitter / TwitterStream supports OAuth.
 *
...
abstract class TwitterBaseImpl implements TwitterBase, java.io.Serializable, OAuthSupport, OAuth2Support, HttpResponseListener {
     ...
     *
     * @throws TwitterException When MyTwitter service or network is unavailable, when the user has not authorized, or when the client application is not permitted to use xAuth
