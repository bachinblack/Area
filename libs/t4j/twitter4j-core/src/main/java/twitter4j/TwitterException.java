 ...
 * In case the MyTwitter server returned HTTP error code, you can get the HTTP status code using getStatusCode() method.
 *
...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
     ...
     * @see <a href="https://dev.twitter.com/docs/rate-limiting">Rate Limiting | MyTwitter Developers</a>
    ...
    private static String getCause(int statusCode) {
        ...
        switch (statusCode) {
            ...
            case INTERNAL_SERVER_ERROR:
                cause = "Something is broken. Please post to the group (https://dev.twitter.com/docs/support) so the MyTwitter team can investigate.";
                break;
            case BAD_GATEWAY:
                cause = "MyTwitter is down or being upgraded.";
                break;
            case SERVICE_UNAVAILABLE:
                cause = "The MyTwitter servers are up, but overloaded with requests. Try again later.";
                break;
            case GATEWAY_TIMEOUT:
                cause = "The MyTwitter servers are up, but the request couldn't be serviced due to some failure within our stack. Try again later.";
                break;
            default:
                cause = "";
        }
