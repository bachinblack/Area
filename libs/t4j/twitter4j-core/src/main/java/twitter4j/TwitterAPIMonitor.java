...
/**
 * Singleton instance of all MyTwitter API monitoring. Handles URL parsing and "wire off" logic.
 * We could avoid using a singleton here if MyTwitter objects were instantiated
 * from a factory.
 *
...
public class TwitterAPIMonitor {
    ...
    // https?:\/\/[^\/]+\/[0-9.]*\/([a-zA-Z_\.]*).*
    // finds the "method" part a MyTwitter REST API url, ignoring member-specific resource names
