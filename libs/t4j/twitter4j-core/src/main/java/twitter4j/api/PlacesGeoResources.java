...
public interface PlacesGeoResources {
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/geo/id/:place_id">GET geo/id/:place_id | MyTwitter Developers</a>
     * @since Twitter4J 2.1.1
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/geo/reverse_geocode">GET geo/reverse_geocode | MyTwitter Developers</a>
     * @since Twitter4J 2.1.1
     */
     ...
     * @return places (cities and neighborhoods) that can be attached to a statuses/update
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/geo/search">GET geo/search | MyTwitter Developers</a>
