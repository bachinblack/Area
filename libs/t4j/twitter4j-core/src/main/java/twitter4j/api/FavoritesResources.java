...
public interface FavoritesResources {
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/favorites">GET favorites | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/favorites/create/:id">POST favorites/create/:id | MyTwitter Developers</a>
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/favorites/destroy/:id">POST favorites/destroy/:id | MyTwitter Developers</a>
     */
