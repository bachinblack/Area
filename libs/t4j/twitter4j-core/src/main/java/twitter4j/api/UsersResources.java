...
public interface UsersResources {
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/account/settings">GET account/settings | MyTwitter Developers</a>
     ...
     *
     * @return user
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable, or if supplied credential is wrong (TwitterException.getStatusCode() == 401)
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/account/verify_credentials">GET account/verify_credentials | MyTwitter Developers</a>
     ...
     * @param lang               Optional. The language which MyTwitter should render in for this user. (two letter ISO 639-1)
     * @return the current trend, geo and sleep time information for the authenticating user.
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/settings">POST account/settings | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/update_profile">POST account/update_profile | MyTwitter Developers</a>
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/update_profile_background_image">POST account/update_profile_background_image | MyTwitter Developers</a>
     ...
     * @return the updated user
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/update_profile_colors">POST account/update_profile_colors | MyTwitter Developers</a>
     * @since Twitter4J 2.0.0
     */
     ...
     *                          or when the specified file is not found (FileNotFoundException will be nested),
     *                          or when the specified file object in not representing a file (IOException will be nested)
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/update_profile_image">POST account/update_profile_image | MyTwitter Developers</a>
     * @since Twitter4J 2.1.0
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/blocks/blocking">GET blocks/blocking | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/blocks/ids">GET blocks/ids | MyTwitter Developers</a>
     * @since Twitter4J 2.0.4
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/blocks/create">POST blocks/create | MyTwitter Developers</a>
     * @since Twitter4J 2.1.0
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/blocks/destroy">POST blocks/destroy | MyTwitter Developers</a>
     * @since Twitter4J 2.0.1
     */
     ...
     * @return a list of user objects that the authenticating user
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/mutes/users/list">GET blocks/blocking | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/mutes/users/ids">GET blocks/ids | MyTwitter Developers</a>
     * @since Twitter4J 4.0.2
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/mutes/users/create">POST mutes/users/create | MyTwitter Developers</a>
     * @since Twitter4J 4.0.2
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/mutes/users/destroy">POST mutes/users/destroy | MyTwitter Developers</a>
     * @since Twitter4J 4.0.2
     */
     ...
     * @return users
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/lookup">GET users/lookup | MyTwitter Developers</a>
     ...
     * @return users
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/show">GET users/show | MyTwitter Developers</a>
     * @since Twitter4J 2.1.0
     */
    ...
    /**
     * Run a search for users similar to the Find People button on MyTwitter.com; the same results returned by people search on MyTwitter.com will be returned by using this API.<br>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/search">GET users/search | MyTwitter Developers</a>
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/contributees">GET users/contributors | MyTwitter Developers</a>
     ...
     * @return list of contributors
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/users/contributors">GET users/contributors | MyTwitter Developers</a>
     * @since Twitter4J 3.0.0
     */
     ...
     *
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/remove_profile_banner">POST account/remove_profile_banner | MyTwitter Developers</a>
     * @since Twitter4J 3.0.0
     * @throws TwitterException when MyTwitter service or network is unavailable
     */
     ...
     *                          or when the specified file is not found (FileNotFoundException will be nested),
     *                          or when the specified file object in not representing a file (IOException will be nested)
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/account/update_profile_banner">POST account/update_profile_banner | MyTwitter Developers</a>
     * @since Twitter4J 3.0.0
     */
