...
public interface FriendsFollowersResources {
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/no_retweets/ids">GET friendships/no_retweets/ids | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friends/ids">GET friends/ids | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/followers/ids">GET followers/ids | MyTwitter Developers</a>
     * @since Twitter4J 2.0.10
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="http://groups.google.com/group/twitter-api-announce/msg/34909da7c399169e">#newtwitter and the API - MyTwitter API Announcements | Google Group</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/incoming">GET friendships/incoming | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/outgoing">GET friendships/outgoing | MyTwitter Developers</a>
     * @since Twitter4J 2.1.2
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/friendships/create">POST friendships/create | MyTwitter Developers</a>
     ...
     * @return User
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/friendships/destroy">POST friendships/destroy | MyTwitter Developers</a>
     * @since Twitter4J 2.1.0
     */
     ...
     * @return Relationship
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/show">GET friendships/show | MyTwitter Developers</a>
     * @since Twitter4J 2.1.0
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friends/list">GET friends/list | MyTwitter Developers</a>
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/followers/list">GET followers/list | MyTwitter Developers</a>
     * @since Twitter4J 3.0.2
     */
