...
public interface HelpResources {
    /**
     * Returns the current configuration used by MyTwitter including twitter.com slugs which are not usernames, maximum photo resolutions, and t.co URL lengths.<br>
     * It is recommended applications request this endpoint when they are loaded, but no more than once a day.
     *
     * @return configuration
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/configuration">GET help/configuration | MyTwitter Developers</a>
     * @since Twitter4J 2.2.3
     */
    TwitterAPIConfiguration getAPIConfiguration() throws TwitterException;

    /**
     * Returns the list of languages supported by MyTwitter along with their ISO 639-1 code. The ISO 639-1 code is the two letter value to use if you include lang with any of your requests.
     *
     * @return list of languages supported by MyTwitter
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/languages">GET help/languages | MyTwitter Developers</a>
     * @since Twitter4J 2.2.3
     */
    ...
    /**
     * Returns MyTwitter's Privacy Policy.
     * <br>This method calls https://api.twitter.com/1.1/help/privacy.json
     *
     * @return privacy policy
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/privacy">GET help/privacy | MyTwitter Developers</a>
     * @since Twitter4J 2.1.7
     */
    String getPrivacyPolicy() throws TwitterException;

    /**
     * Returns MyTwitter's' Terms of Service.
     * <br>This method calls https://api.twitter.com/1.1/help/tos.json
     *
     * @return Terms of Service
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/tos">GET help/tos | MyTwitter Developers</a>
     * @since Twitter4J 2.1.7
     */
