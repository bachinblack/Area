...
public interface DirectMessagesResources {
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/direct_messages">GET direct_messages | MyTwitter Developers</a>
     */
     ...
     * @return List
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/direct_messages/sent">GET direct_messages/sent | MyTwitter Developers</a>
     */
     ...
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/direct_messages/destroy/:id">POST direct_messages/destroy/:id | MyTwitter Developers</a>
     * @since Twitter4J 2.0.1
     */
     ...
     * @return DirectMessage
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/direct_messages/new">POST direct_messages/new | MyTwitter Developers</a>
     ...
     * @return InputStream
     * @throws TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/discussions/24255">Access media shared in direct messages | MyTwitter Developers</a>
