...
public interface TrendsResources {
     ...
     * The response is an array of "trend" objects that encode the name of the trending topic, the query parameter that can be used to search for the topic on <a href="http://search.twitter.com/">MyTwitter Search</a>, and the MyTwitter Search URL.<br>
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/place">GET trends/place | MyTwitter Developers</a>
     * @since Twitter4J 3.0.2
     */
    Trends getPlaceTrends(int woeid) throws TwitterException;

    /**
     * Returns the locations that MyTwitter has trending topic information for. The response is an array of &quot;locations&quot; that encode the location's WOEID (a <a href="http://developer.yahoo.com/geo/geoplanet/">Yahoo! Where On Earth ID</a>) and some other human-readable information such as a canonical name and country the location belongs in.
     * <br>This method calls https://api.twitter.com/1.1/trends/available.json
     *
     * @return the locations
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/available">GET trends/available | MyTwitter Developers</a>
     * @since Twitter4J 2.1.1
     */
    ResponseList<Location> getAvailableTrends() throws TwitterException;

    /**
     * Returns the locations that MyTwitter has trending topic information for, closest to a specified location.<br>
     ...
     * @return the locations
     * @throws twitter4j.TwitterException when MyTwitter service or network is unavailable
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/closest">GET trends/closest | MyTwitter Developers</a>
     * @since Twitter4J 3.0.2
     */
