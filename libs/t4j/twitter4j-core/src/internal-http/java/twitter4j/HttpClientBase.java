...
public abstract class HttpClientBase implements HttpClient, Serializable {
    ...
    public HttpClientBase(HttpClientConfiguration conf) {
        ...
        requestHeaders.put("X-MyTwitter-Client-Version", Version.getVersion());
        requestHeaders.put("X-MyTwitter-Client-URL", "http://twitter4j.org/en/twitter4j-" + Version.getVersion() + ".xml");
        requestHeaders.put("X-MyTwitter-Client", "Twitter4J");
