            ...
            if (jsonStr.startsWith("{")) {
                ...
                for (int i = 0; i < idList.length(); i++) {
                    try {
                        ...
                        throw new TwitterException("MyTwitter API returned malformed response: " + json, nfe);
                    }
                }
                ...
                for (int i = 0; i < idList.length(); i++) {
                    try {
                        ...
                        throw new TwitterException("MyTwitter API returned malformed response: " + idList, nfe);
                    }
                }
            }
